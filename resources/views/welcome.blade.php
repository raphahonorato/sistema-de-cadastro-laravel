    ...
    <style>
        ...
        *,
        ...
        @media (prefers-color-scheme: dark) {
            ...
            .linha {
                margin-bottom: 15px;
                /* Define o espaçamento entre cada linha */
                width: 100%;
                text-align: center;
            }
            ...
            /* Estilos para as bordas da tabela */
            table,
            th,
            td {
            ...
            /* Listras nas linhas para facilitar leitura */
            /* tr:nth-child(even) {
            ...
            img {
  user-select: none; /* Evita que a imagem seja selecionada */
...
<body class="font-sans antialiased dark:bg-black dark:text-white/50">
    <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
        ...
        <h1>CRUD Cadastro de Produtos</h1>
        <div id="container-form">
            <form id="formulario">
                <p>Criar Produto</p>
                <div class="linha">
                    <label for="NomeProduto1">Nome</label>
        ...
        <div id="container-form">
            <form id="formulario">
                ...
                <div class="linha">
                    ...
                    <input type="number" id="idProduto" style="width: 50px; color: black" value="1" />
                </div>
                <button class="btn" href="#">Enviar</button>
            </form>
        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <td>R$ 50,00</td>
                    <td><button class="btn-laravel">Editar</button> <button class="btn-laravel">Excluir</button></td>
                </tr>
                <tr>
                    <td>2</td>
                    <td>Produto B</td>
